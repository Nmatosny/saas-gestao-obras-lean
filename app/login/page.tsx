...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 rounded-[2.5rem] w-full max-w-md relative z-10 shadow-2xl">
        <div className="text-center mb-10">
           ...
           <h1 className="text-3xl font-black text-white tracking-tight italic">ANTIGRAVITY</h1>
           <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest mt-2">SaaS Engineering Terminal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
             ...
             <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-blue-500 transition-all font-medium"
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-500 text-white py-5 rounded-2xl font-black uppercase tracking-widest transition-all shadow-xl shadow-blue-600/20 disabled:opacity-50"
          >
        ...
        <p className="text-center text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-10">
          Não tem uma conta? <a href="/register" className="text-blue-500 hover:text-blue-400">Solicitar Acesso</a>
        </p>
      </div>
    </div>
  )
